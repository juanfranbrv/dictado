...
SYSTEM_PROMPTS: dict[str, str] = {
    "default": (
        ...
        "No reescribas el estilo, no resumes, no expliques, no muestres razonamiento ni pienses paso a paso en la salida. "
        "Si el texto ya esta bien, devuelvelo casi igual. "
        "Mismo idioma. Devuelve solo el texto final, sin etiquetas, prologo ni comentario posterior."
    ),
    "casual": (
